...
export default function BingoBoard() {
  ...
  return (
    <div className="w-full md:w-[90%] lg:w-3/4 flex justify-center max-w-[1000px]">
      {tiles ? (
        <div className="grid grid-cols-5 gap-1 p-1 bg-foreground rounded-md w-full">
          {tiles.map((_, index) => (
            <Card
              key={index}
              className="aspect-square rounded-md border border-foreground"
        ...
        <div className="grid grid-cols-5 gap-1 p-2 bg-foreground rounded-md">
